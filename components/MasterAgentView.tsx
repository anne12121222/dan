        ...
        <Card>
            <div className="p-4 border-b border-gray-700 flex items-center justify-between">
                ...
                <div className="text-right">
                    <p className="text-xs text-green-400">Commission</p>
                    <p className="text-lg font-bold text-green-400">{currentUser.commissionBalance.toLocaleString()} C</p>
                </div>
            </div>
      ...
      <div className="space-y-6">
        <Card>
            ...
            <form onSubmit={handleCreateAgent} className="p-4 space-y-4">
                ...
                <div>
                    <label htmlFor="agent-email" className="block text-sm font-medium text-gray-300">Agent Email</label>
